...
export function MeetOurTeam() { return <section id="people" className="content-section wrap team-section"><div className="team-intro"><div><Eyebrow>The people behind the questions</Eyebrow><h2>Meet our team.</h2></div><div><p>Oak Field is built by researchers, engineers and scientists who bring different disciplines to the same questions. Meet some of the people researching markets and building systematic solutions.</p><Link href="/join-our-team" className="button">Explore careers<Arrow/></Link></div></div><TeamCarousel members={team}/></section>; }
const footerIcons = {
